...
@section('content')
{{ HTML::ul($errors->all()) }}
{{ Form::model($expenses, array('route' => array('expenses.update', $expenses->id), 'method' => 'PUT')) }}
...
{{Form::hidden('materialsfee', 0)}}
	...
	<tr><td><strong>Accommodation Fee (July-August)</strong><td>{{Form::select('acc0', array(0=>'None',1=>'Residence - Double', 2=>'Residence - Single', 3=>'Homestay'))}}
	<tr><td><strong>Accommodation Fee (September-December)</strong><td>{{Form::select('acc1', array(0=>'None', 1=>'Residence - Double', 2=>'Residence - Single', 3=>'Homestay'))}}
	<tr><td><strong>Accommodation Fee (January-April)</strong><td>{{Form::select('acc2', array(0=>'None', 1=>'Residence - Double', 2=>'Residence - Single', 3=>'Homestay'))}}
	<tr><td><strong>Accommodation Fee (May-June)</strong><td>{{Form::select('acc3', array(0=>'None', 1=>'Residence - Double', 2=>'Residence - Single', 3=>'Homestay'))}}
