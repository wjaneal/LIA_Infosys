...
#Note Routes:
   Route::any("/notes", [
    ...
    Route::any("/notes/selectindividual}", [
        "as"   => "notes/selectindividual",
        "uses" => "NotesController@selectindividual"
    ]);
    Route::any("/notes/listindividual}", [
        "as"   => "notes/listindividual",
        "uses" => "NotesController@listindividual"
    ]);
#Staffnote Routes:
   Route::any("/staffnotes", [
        "as"   => "staffnotes",
        "uses" => "StaffnotesController@index"
    ]);
    Route::any("/staffnotes/create/{view}", [
        "as"   => "staffnotes/create",
        "uses" => "StaffnotesController@create"
    ]);
    Route::any("/staffnotes/selectindividual", [
        "as"   => "staffnotes/selectindividual",
        "uses" => "StaffnotesController@selectindividual"
    ]);
    Route::any("/staffnotes/listindividual", [
        "as"   => "staffnotes/listindividual",
        "uses" => "StaffnotesController@listindividual"
    ]);
#Expense Routes:
#Expense Routes:
...
#Attendance Routs: 
  Route::any("/attendance/create/{cid}", [
	"as" => "attendance/create/{cid}", 
...
#Resource Routes:
	...
	Route::resource("notes", "NotesController" );
    	Route::resource("staffnotes", "StaffnotesController");
